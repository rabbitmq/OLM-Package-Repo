...
replace_rabbitmq_cluster_operator_version_overlay("./overlays/overlay-permission.yaml", version)
replace_rabbitmq_cluster_operator_version_overlay("./overlays/overlay-cluster-permission.yaml", version)
replace_rabbitmq_cluster_operator_version_overlay("./overlays/overlay-deployment.yaml", version)
