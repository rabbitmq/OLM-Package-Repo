...
replace_rabbitmq_cluster_operator_image("./generators/cluster-service-version-generator.yml","rabbitmqoperator/single-active-consumer-operator:"+oldversion, "rabbitmqoperator/single-active-consumer-operator:"+version)
replace_rabbitmq_cluster_operator_image("./generators/cluster-service-version-generator-openshift.yml","rabbitmqoperator/single-active-consumer-operator:"+oldversion, "rabbitmqoperator/single-active-consumer-operator:"+version)
# Apply version to the service-version generator
ytt_command_add_version = "ytt -f ./generators/cluster-service-version-generator.yml --data-value-yaml name=rabbitmq-single-active-consumer-operator.v"+version+" --data-value-yaml version="+version+ " --data-value-yaml replaces="+replaces+ "> ./tmpmanifests/cluster-service-version-generator.yaml"
...
replace_rabbitmq_cluster_operator_version_overlay("./overlays/overlay-permission.yaml", "rabbitmq-single-active-consumer-operator.v*", "rabbitmq-single-active-consumer-operator.v"+version)
replace_rabbitmq_cluster_operator_version_overlay("./overlays/overlay-cluster-permission.yaml", "rabbitmq-single-active-consumer-operator.v*","rabbitmq-single-active-consumer-operator.v"+version)
replace_rabbitmq_cluster_operator_version_overlay("./overlays/overlay-deployment.yaml", "rabbitmq-single-active-consumer-operator.v*", "rabbitmq-single-active-consumer-operator.v"+version)
