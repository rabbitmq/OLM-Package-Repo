...
sed -i -e "s/0.0.0/$VERSION/g" $PWD/OLM-Package-Repo/testfiles/rabbitmq-messaging-operator-catalog.yaml
sed -i -e "s/0.0.0/$VERSION/g" $PWD/OLM-Package-Repo/testfiles/rabbitmq-messaging-operator-subscription.yaml
